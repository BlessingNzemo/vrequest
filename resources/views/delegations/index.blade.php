                            ...
                            @foreach ($delegations as $i => $item)
                                <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                    ...
                                    <td class="flex p-5 items-center gap-0.5">
                                        ...
                                        <a href="{{ route('delegations.edit', $item->id) }}" class="p-2  rounded-full bg-white group transition-all duration-500 hover:bg-indigo-600 flex item-center" title="Editer cette délégation">
                                        ...
                                        <a onclick="supprimer(event);" data-modal-target="suppDelegation-modal" data-modal-toggle="suppDelegation-modal" href="{{ route('delegations.destroy', $item->id) }}" class="p-2 rounded-full bg-white group transition-all duration-500 hover:bg-red-600 flex item-center" title="Supprimer cette délégation">
