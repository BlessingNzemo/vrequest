                            ...
                            @foreach ($delegations as $i => $item)
                                <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                    ...
                                    <td class="flex p-5 items-center gap-0.5">
                                        <button class="p-2  rounded-full bg-white group transition-all duration-500 hover:bg-indigo-600 flex item-center" aria-placeholder="Editer">
                                            ...
                                            <button id="dropdownMenuIconButton" data-dropdown-toggle="dropdownDots{{ $i }} "
                                                ...
                                                <div id="dropdownDots{{ $i }}"
                                                    ...
                                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                                        ...
                                                        <li>
                                                            <a href="{{ route('delegations.show', $item->id) }}" data-modal-target="show-modal" data-modal-toggle="show-modal"
                                                        ...
                                                        @if ($item->is_validated == 0)
                                                            <li>
                                                                <a href="{{ route('delegations.edit', $item->id) }}"
