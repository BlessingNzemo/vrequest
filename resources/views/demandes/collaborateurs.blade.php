                                        ...
                                        <div id="dropdownDots{{$i}}"  class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconButton">
                                                ...
                                                @if (Session::get('userIsManager') || Session::get('delegation'))
                                                    @if($item->is_validated == 0 )
                                                        <li>
                                                            <a href="{{route('envoyermailauchefcharroi',$item->id)}}" data-modal-target="popup-modal" data-modal-toggle="popup-modal" onclick="valider(event)" id="ButtonValider" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                                <span class="flex items-center">
