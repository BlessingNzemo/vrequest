                    ...
                    <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div id="defaultTabContent">
                                ...
                                <table id="" class="table-auto min-w-full rounded-xl">
                                    <thead>
                                        <tr class="bg-gray-100">
                                            ...
                                            <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Validation du  Manager </th>
                                    ...
                                    <tbody class="divide-y divide-gray-300 ">
                                        @foreach ($demandes->sortBy('is_validated')->sortBy('status')->sortBy('manager_id') as $i => $item)
                                            <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {{ substr($item->motif, 0, 30) }}</td>
                                                <td class=" px-5 py-3">
                            ...
                            <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="services" role="tabpanel" aria-labelledby="services-tab">
                                <dl class="grid max-w-screen-xl grid-cols-1 gap-8 p-4 mx-auto text-gray-900 sm-grid-cols-1 sm-grid-cols-2 sm-grid-cols-3 sm-grid-cols-4 sm-grid-cols-5 xl:grid-cols-6 dark:text-white sm:p-8">
                                        ...
                                        <div style="margin-bottom: 2.5%; margin-right: 2.5%;" class="flex flex-col">
                                            <a href="{{ route('demandes.show', $item->Url) }}">
                                                <div style=" display:inline-block" class="flex flex-col justify-center items-center ">
                                                    <div class="bg-white dark:bg-dark rounded-lg shadow-lg overflow-hidden max-w-lg w-full">
                                                        <div class="p-6">
                                                            <h2 style="margin-bottom: 7%" class="dark:text-dark text-2xl font-bold text-gray-800 mb-2">{{ __($item->ticket) }}</h2>
                                                            <div style="justify-content:space-between;" class="flex items-center">
                                                                <div class="flex items-center">
                                                                    ...
                                                                    <span class="dark:text-dark sm:creater-size text-gray-800 font-semibold">{{ __($item->user()->first()->last_name." ".$item->user()->first()->first_name ) }}</span>
                                                                </div>
                                                                <div class="sm:flex-button text-gray-600">
                                                                    <a href="{{route('demandes.show', $item->Url) }}" style="padding-right: 0.7rem" class="block hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                                                                stroke="currentColor" class="dark:text-dark" width="20" height="20">
                                                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                                                        d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                                                                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                                            </svg>
                                                                    ...
                                                                    @if ($item->is_validated == 0)
                                                                        <a id="action-edit" href="{{ route('demandes.edit', $item->id) }}" style="padding-right: 0.7rem" data-modal-target="popup-modal" data-modal-toggle="popup-modal" onclick="edit(event);"
                                                            ...
                                                            <div style="margin-right: 5%;margin-top:3%;" class="flex justify-between items-center">
                                                                <div class="flex items-center">
                                                                    <span class="dark:text-dark sm:creater-size text-gray-600">{{ __($item->created_at->toDateTimeString()) }}</span>
                                                                </div>
