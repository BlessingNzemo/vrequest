        ...
        <div class="min-w-full inline-block align-middle">
            <div class="overflow-hidden rounded-lg border-gray-300">
                <div style="padding-right: 2%;
                    ...
                    @if(!empty($_GET['view']))
                        @if($_GET['view'] == 'list')
                            <a style="color: white;" href="?view=grid" data-toggle="tooltip" data-placement="right" title="Afficher sous forme de grille">Grid</a>
                        @else
                            <a style="color: white;" href="?view=list" data-toggle="tooltip" data-placement="right" title="Afficher sous forme de liste">Liste</a>
                        @endif
                    @else
                        <a style="color: white;" href="?view=list" data-toggle="tooltip" data-placement="right" title="Afficher sous forme de liste">Liste</a>
                    @endif
