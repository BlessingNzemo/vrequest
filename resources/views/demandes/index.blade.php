                         ...
                         @foreach ($demandes->sortByDesc('id') as $i => $item)
                             <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                ...
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                        ...
                                        @if ($item->status=='1')
                                            <div class="py-1.5 px-2.5 bg-emerald-300 rounded-full flex justify-center w-20 items-center gap-1">
                                        ...
                                        @endif
                                        @if ($item->status=='0')
                                            <div class="py-1.5 px-2.5 bg-orange-300 rounded-full flex w-20 justify-center items-center gap-1">
                                                <svg width="5" height="6" viewBox="0 0 5 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        @if (($item->status=='2'))
                                            <div class="py-1.5 px-2.5 bg-red-300 rounded-full flex w-20 justify-center items-center gap-1">
                                                <svg width="5" height="6" viewBox="0 0 5 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <circle cx="2.5" cy="3" r="2.5" fill="#DC2626"></circle>
                                                </svg>
                                            ...
                                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                                ...
                                                <li>
                                                    <a href="{{ route('demandes.show', $item->id) }}" data-modal-target="show-modal" data-modal-toggle="show-modal"
                                                        onclick="show(event);"   class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
