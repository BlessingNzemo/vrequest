                    ...
                    <table id="example" class="table-auto min-w-full rounded-xl">
                        <thead>
                            <tr class="bg-gray-100 dark:bg-gray-200">
                                <th scope="col" class="p-5 text-center whitespace-normal text-sm leading-6 font-semibold text-gray-900 capitalize min-w-[150px]"> Motif</th>
                                <th scope="col" class="p-5 text-center whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 "> Destination </th>
                                <th scope="col" class="p-5 text-center whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 "> Date et Heure de deplacement</th>
                                <th scope="col" class="p-5 text-center whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 "> Nombre de passagers </th>
                                <th scope="col" class="p-5 text-center whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 "> Status du traitement </th>
                                <th scope="col" class="p-5 text-center whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 "> Actions </th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-300 ">
                            @foreach ($demandes->sortBy('is_validated')->sortBy('status')->sortByDesc('date') as $i => $item)
                                    ...
                                    <td class="flex justify-center items-center">
                                        ...
                                        @if ($item->is_validated == 0)
                                            <a href="{{ route('demandes.edit', $item->id) }}" data-modal-target="popup-modal" data-modal-toggle="popup-modal" onclick="edit(event);"
                                                class="block px-4 py-1 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" title="Editer cette demande">                                    
                                            ...
                                            <a onclick="supprimer(event);" data-modal-target="delete-modal"
                                                ...
                                                class="block px-4 py-1 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" title="Supprimer cette demande">
