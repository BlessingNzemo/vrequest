        ...
        <div class="min-w-full inline-block align-middle">
            <div class="overflow-hidden rounded-lg border-gray-300">
                <div style="padding-right: 2%;
                    ...
                    @if(!empty($_GET['view']))
                        @if($_GET['view'] == 'list')
                            <a style="margin-right: 30%" href="?view=grid" data-toggle="tooltip" data-placement="right" title="Afficher sous forme de grille">
                                ...
                                <a href="{{ route('demandes.show', $item->Url) }}">
                                    <div style=" display:inline-block" class="flex flex-col justify-center items-center bg-gray-100">
                                        <div class="bg-white rounded-lg shadow-lg overflow-hidden max-w-lg w-full">
                                            <div class="p-6">
                                                <h2 style="margin-bottom: 7%" class="text-2xl font-bold text-gray-800 mb-2">{{ __(substr($item->motif,0,65)) }}</h2>
                                                <div style="justify-content:space-between;" class="flex items-center">
                                                    <div style="width: 60%" class="flex items-center">
                                                    ...
                                                    <div style="display:inline-flex;" class="text-gray-600">
                                                        ...
                                                        @if ($item->is_validated == 0)
                                                            <a href="{{ route('demandes.edit', $item->id) }}" style="padding-right: 0.7rem" data-modal-target="popup-modal" data-modal-toggle="popup-modal" onclick="edit(event);"
                                                            ...
                                                            <a onclick="supprimer(event);" style="padding-right: 0.7rem" data-modal-target="delete-modal"
                                                                data-modal-toggle="delete-modal"
                                                                href="{{ route('demandes.destroy', $item->id) }}"
                                                                class="block hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
